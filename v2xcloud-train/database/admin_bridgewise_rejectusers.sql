...
--
-- Table structure for table `rejectusers`
--

DROP TABLE IF EXISTS `rejectusers`;
...
--
-- Dumping data for table `rejectusers`
--

LOCK TABLES `rejectusers` WRITE;
/*!40000 ALTER TABLE `rejectusers` DISABLE KEYS */;
/*!40000 ALTER TABLE `rejectusers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-09-15 13:04:05
