...
CREATE TABLE `providerinfo` (
  ...
  `SuiteID` varchar(1024) DEFAULT NULL,
  `SuiteSecret` varchar(1024) DEFAULT NULL,
  `SuiteToken` varchar(1024) DEFAULT NULL,
  `SuiteEncodingAESKey` varchar(1024) DEFAULT NULL,
  `SuiteTicket` varchar(1024) DEFAULT NULL,
  `CorpID` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`id`)
